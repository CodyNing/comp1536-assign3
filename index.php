...
<div class="row">
    <form action="index.php" method="post" class="form-horizontal">
        <div class="col-lg-12 row">
            <div class="col-xs-1 col-sm-offset-4"><?php echo $first; ?></div>
            <div class="col-xs-1"><?php echo $sign; ?></div>
            <div class="col-xs-1"><?php echo $second; ?></div>
        ...
        <div class="col-lg-12 row">
            <div class="col-sm-3 col-sm-offset-4">
                <button type="submit" class="bth bth-default">Submit</button>
            </div>
